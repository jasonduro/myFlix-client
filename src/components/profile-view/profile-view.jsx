...
constructor(props) { 
  ...
  axios.delete("https://myflix-app-jl.herokuapp.com/users/${Username}/movies/${movie._id}", { headers: { Authorization: `Bearer ${token}` } }
  ).then((response) => {
  ...
  getUser = (token) => {
  const Username = localStorage.getItem("user");
  axios.get("https://myflix-app-jl.herokuapp.com/users/${Username}", {
  ...
  editUser = (e) => {e.preventDefault();
    const Username = localStorage.getItem("user");
    const token = localStorage.getItem("token");
  axios.put("https://myflix-app-jl.herokuapp.com/users/${Username}", {
  ...
  axios.delete("https://myflix-app-jl.herokuapp.com/users/${Username}", {
  headers: { Authorization: `Bearer ${token}` },
  })
